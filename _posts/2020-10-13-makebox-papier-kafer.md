...
<!-- /wp:paragraph -->
<!-- wp:image {"id":42328} -->
<figure class="wp-block-image"><img src="{% link _fotos/hobbies/makebox/papier-kafer/Papier-Käfer-003.jpg %}" alt="" class="wp-image-42328"></figure>
<!-- /wp:image -->
<!-- wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:image {"id":42332} -->
<figure class="wp-block-image"><img src="{% link _fotos/hobbies/makebox/papier-kafer/Papier-Käfer-007.jpg %}" alt="" class="wp-image-42332"></figure>
<!-- /wp:image -->
<!-- wp:paragraph -->
Dann habe ich die Käfer gemacht, die sind dreidimensional. Und da habe ich mir schon leichter getan!
<!-- /wp:paragraph -->
<!-- wp:image {"id":42344} -->
<figure class="wp-block-image"><img src="{% link _fotos/hobbies/makebox/papier-kafer/Papier-Käfer-019.jpg %}" alt="" class="wp-image-42344"></figure>
<!-- /wp:image -->
<!-- wp:paragraph -->
...
<figure class="wp-block-image"><a href="{% link _fotos/hobbies/makebox/papier-kafer/index.md %}"><img src="{% link _fotos/hobbies/makebox/papier-kafer/Papier-Käfer-018.jpg %}" alt="" class="wp-image-42343"></a><br>
